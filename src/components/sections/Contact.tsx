      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="p-5 rounded-lg border glass-card">
            ...
            <p className="text-sm text-muted-foreground mb-4">{site.address}</p>
            <div className="flex items-center gap-2 mb-2"><Phone className="h-4 w-4"/> <span className="font-semibold">Phone</span></div>
            <p className="text-sm text-muted-foreground mb-4">{site.phone}</p>
            ...
            <div className="mt-4 flex gap-2">
              <Button asChild variant="secondary"><a href={`tel:${site.phone}`}>Call Now</a></Button>
              <Button asChild variant="hero"><a href={`mailto:${site.email}`}>Email</a></Button>
            </div>
          </div>
          <div className="rounded-lg overflow-hidden border">
            <iframe
              title="Sarkar Sales location map"
